...
import { Map, Compass, Mountain, Trees, Building, Scroll, Castle, Waves, Sparkles, Lock, Trophy } from "lucide-react"
        ...
        <CardContent>
          ...
          <Card className="bg-card/50 border">
            ...
            <CardContent className="space-y-4">
              ...
              <Button className="w-full mt-2" disabled={!currentRegion.unlocked} onClick={handleTravelToRegion}>
                Travel to Region
              </Button>
            </CardContent>
          </Card>
